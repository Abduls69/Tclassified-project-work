...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.part_label = tk.Label(
            self.master, text='Product', font=('bold', 14), pady=20, bg = 'yellow')
        ...
        self.customer_label = tk.Label(
            self.master, text='Common name', font=('bold', 14), bg = 'yellow')
        ...
        self.retailer_label = tk.Label(
            self.master, text='Amount in stock', font=('bold', 14), bg = 'yellow')
        ...
        self.price_label = tk.Label(
            self.master, text='Price', font=('bold', 14), bg = 'yellow')
